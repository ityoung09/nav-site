...
import { categories, featuredResources, codeSnippets, developerTools } from "@/lib/data"
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Manage your DevHub content and resources</p>
        </div>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>Manage navigation categories</CardDescription>
                </div>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>Manage featured resources</CardDescription>
                </div>
                <Button asChild size="sm">
