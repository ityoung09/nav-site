  ...
  return (
    <div className="p-4 md:p-6">
      <div className="max-w-7xl mx-auto">
        {/* Hero Section */}
        <div className="mb-8">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">Developer Resource Hub</h1>
          <p className="text-lg md:text-xl text-muted-foreground mb-6">
            Your comprehensive platform for development resources, tools, and community connections
          </p>
